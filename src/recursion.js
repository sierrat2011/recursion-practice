...
var range =  function(x, y, output = []){
  ...
  return output.concat(x + compass, range(x + compass, y));
}
...
var reverseArr = function (array) {
  ...
  let letter = array.length - 1
  return [array[letter], ...reverseArr(array.slice(0, letter))]
};
...
var capitalizeFirst = function(array) {
  ...
  let arr = array[0]
  return [arr[0].toUpperCase() + arr.slice(1), ...capitalizeFirst(array.slice(1))]
};
